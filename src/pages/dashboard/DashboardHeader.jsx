...
export default function DashboardHeader({ toggleMobileSidebar }) {
  ...
  return (
    <motion.header
      ...
      className="h-20 glass-card border-none rounded-none flex items-center justify-between px-6 bg-background/60 dark:bg-background/60 backdrop-blur-md border-b border-border/50 sticky top-0 z-30"
    >
      <button
